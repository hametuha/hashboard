...
foreach ( $service_manager->service_list() as $service ) :
	...
	<div class="hb-gianism-title">
		<i class="lsf lsf-<?php echo esc_attr( $service_instance->service_name ); ?>"></i> <?php echo esc_html( $service_instance->verbose_service_name ); ?>
	</div>
		<div class="hb-giasnim-status">
			<p class="description">
				<?php echo esc_html( $service_instance->connection_message( $is_connected ? 'connected' : 'disconnected' ) ); ?>
			</p>
		</div>
